...
public class EncryptedPropertiesExtensionLoadingDelegate implements ExtensionLoadingDelegate {


	  // TODO replace with you extension name. This must be a meaningful name for this module.
	    public static final String EXTENSION_NAME = "RSA Encryption Utility";
	  ...
	  public void accept(ExtensionDeclarer extensionDeclarer, ExtensionLoadingContext context) {
	    ConfigurationDeclarer configurationDeclarer = extensionDeclarer.named(EXTENSION_NAME)
	        ...
	        .fromVendor("MuleSoft Professional Services")
	    ...
	    defaultParameterGroup
        .withRequiredParameter("keystorepath").ofType(BaseTypeBuilder.create(JAVA).stringType().build())
        .withExpressionSupport(NOT_SUPPORTED)
        .describedAs(" Meaningful description of what customParameter is for");
	    defaultParameterGroup
        .withRequiredParameter("keystorepass").ofType(BaseTypeBuilder.create(JAVA).stringType().build())
        .withExpressionSupport(NOT_SUPPORTED)
        .describedAs(" Meaningful description of what customParameter is for");
	    defaultParameterGroup
        .withRequiredParameter("keypass").ofType(BaseTypeBuilder.create(JAVA).stringType().build())
        .withExpressionSupport(NOT_SUPPORTED)
        .describedAs(" Meaningful description of what customParameter is for");
	    defaultParameterGroup
        .withRequiredParameter("keyAlias").ofType(BaseTypeBuilder.create(JAVA).stringType().build())
        .withExpressionSupport(NOT_SUPPORTED)
        .describedAs(" Meaningful description of what customParameter is for");
	  }
}
